  ...
  render(){
    ...
    return (
      <Card>
          ...
          <CardBody>
              <CardTitle className="indc-title vazir-font" >{this.state.crdTitle}</CardTitle>
              <CardSubtitle className="indc-subtitle vazir-font" >{this.state.crdSubttl}</CardSubtitle>
              <CardText className="indc-description vazir-font">{this.state.crdText}</CardText>
          </CardBody>
      </Card>
